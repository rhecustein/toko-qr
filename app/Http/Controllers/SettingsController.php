...
class SettingsController extends Controller
{
    ...
    public function site_settings(Request $request)
    {
        ...
        $sidebarSettings = $request->only('name', 'live_notification');
    ...
    public function checkNotification(Request $request)
    {
        ...
        $noti = Notification::where('created_at', '>', $request->time)->where('to_user_id', auth()->id())->get();

        return response()->json(['status' => 'success', 'data' => $noti]);
    }
}
