                            ...
                            @if($plans)
                                @foreach($plans as $plan)
                                    <tr>
                                        ...
                                        <td>{{$plan->table_unlimited=='yes'?trans('layout.unlimited'):$plan->table_limit}}</td>
                                        <td>{{$plan->restaurant_unlimited=='yes'?trans('layout.unlimited'):$plan->restaurant_limit}}</td>
                                        <td>{{$plan->item_unlimited=='yes'?trans('layout.unlimited'):$plan->item_limit}}</td>
                                        <td>
