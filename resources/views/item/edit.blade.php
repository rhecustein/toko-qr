...
@section('title',trans('layout.item_edit'))
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                ...
                <p class="mb-0">{{trans('layout.item_edit')}}</p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('item.update',$item)}}" method="post" id="step-form-horizontal"
...
@section('js')
    ...
    <script>
        let extraCount={{$item->extras()->count()}};
