...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card mt-3">
            <div class="card-header"><strong>{{trans('layout.order')}} #{{$order->id}}</strong> <span
                    class="float-right">
            ...
            <div class="card-body">
                <div class="row mb-5">
                    <div style="width: 50%;" class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div>{{trans('layout.email')}}: {{$order->restaurant->email}}</div>
                        <div>{{trans('layout.phone_number')}}: {{$order->restaurant->phone_number}}</div>
                        <div>{{trans('layout.add')}}: {{$order->restaurant->location}}</div>
                    </div>
                    <div style="width: 50%;margin-bottom: 20px;top:-20px" class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        @if($order->user)
                            ...
                            <div>{{trans('layout.phone')}}: {{$order->user->phone_number}}</div>
                        @endif
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($order->details as $key=>$details)
                            ...
                            <tr>
                                ...
                                <td>{{formatNumberWithCurrSymbol($details->tax_amount)}}
                                <td>{{formatNumberWithCurrSymbol($details->total+$details->tax_amount)}}
