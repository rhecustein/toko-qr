...
@section('title',trans('layout.tax_edit'))
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                ...
                <p class="mb-0">{{trans('layout.tax_edit')}}</p>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">{{trans('layout.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('tax.index')}}">{{trans('layout.tax')}}</a></li>
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('tax.update',$tax)}}" method="post" id="step-form-horizontal"
