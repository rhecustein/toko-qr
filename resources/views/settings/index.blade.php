                                                    ...
                                                    @can('site_setting')
                                                        <div id="v-pills-siteSettings"
                                                            ...
                                                            <form action="{{route('side.bar.settings')}}" method="post"
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Live Notification</label>
                                                                    <select class="form-control" name="live_notification" id="live_notification">
                                                                        <option {{isset($site_setting->live_notification) && $site_setting->live_notification=='enable'?'selected':''}} value="enable">{{trans('layout.enable')}}</option>
                                                                        <option {{isset($site_setting->live_notification) && $site_setting->live_notification=='disable'?'selected':''}} value="disable">{{trans('layout.disable')}}</option>
                                                                    </select>
                                                                </div>
                                                                <button type="submit"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6">
                                                                            ...
                                                                            <select name="direction" class="form-control">
                                                                                <option {{isset($local_setting->direction) && $local_setting->direction=='ltr'?'selected':''}} value="ltr">LTR</option>
                                                                                <option {{isset($local_setting->direction) && $local_setting->direction=='rtl'?'selected':''}} value="rtl">RTL</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="v-pills-orderPlaced" class="tab-pane fade">
                                                                <form action="{{route('email.template.store')}}"
                                                                    ...
                                                                    <div>{customer_name} = Customer Name</div>
                                                                    <div>{order_no} = Order No </div>
                                                                    <div>{total_amount} = Total Amount</div>
                                                                    <button type="submit"
                                                                            class="btn btn-primary float-right mt-4">
                                                                        {{trans('layout.submit')}}
                                                                    </button>
