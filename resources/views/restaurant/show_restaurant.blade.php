            ...
            <div class="category-item-wrapper" id="category-item-wrapper-{{$categoryItems[0]->category_id}}">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="">
                            <h2><span>{{$categoryName}}'s</span> {{trans('layout.items')}} </h2>
                        </div>
                    </div>
                                    ...
                                    <div class="new-arrival-product">
                                        ...
                                        <div class="new-arrival-content text-center mt-3">
                                            ...
                                            <div class="price">
                                                ...
                                                @endif
                                                @if($item->tax->title)
                                                    <div class="item-tax" id="item-tax-{{$item->id}}"
                            ...
                            <div class="order-items-payment">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{auth()->check()?auth()->user()->phone_number:''}}" name="phone"
...
@section('js')
    ...
    <script !src="">
        ...
        $(document).on('click', '.add-to-cart', function (e) {
            ...
            const taxSection = $('#item-tax-' + item.id);
            let taxAmount = 0;
            let taxType = '';
